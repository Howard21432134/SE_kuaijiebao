  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-title">
        <el-row v-show="$store.state.topNavState==='home'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              ...
              <el-menu-item index="/fpManager">我要理财(会川慧，rename Path name ver)</el-menu-item>
        ...
        <el-row v-show="$store.state.topNavState==='fp'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/fpManager">理财产品管理</el-menu-item>
              <el-menu-item index="/myfpManager">我的债权</el-menu-item>
              <el-menu-item index="/transferfpManager">债权转让</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
