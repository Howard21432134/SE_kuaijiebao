...
/*
    ...
    */
    ...
    //************Financial Product(rename path names ver) Module***************//
    {
      path: '/fpManager',//these three name should be the same.
      type: 'fp',        //
      name: 'fp',        //
      component: Home,
      redirect: '/fp/list',    //should redirect to its children path
      menuShow: true,
      children: [
        {
          path: '/fp/list',
    ...
    {
      path: '/transferfpManager',
      type: 'fp',
      name: 'transferfpManager',
      component: Home,
      redirect: '/fp/accept',
      menuShow: true,
      children: [
